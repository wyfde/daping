<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="仓库位置" prop="position">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['storage:manage:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['storage:manage:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['storage:manage:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="仓库编号" prop="storageCode">
          <el-input v-model="form.storageCode" placeholder="请输入仓库编号" />
        </el-form-item>
        <el-form-item label="仓库名称" prop="storageName">
        ...
        <el-form-item label="仓库位置" prop="position">
          <el-input v-model="form.position" placeholder="请输入仓库位置" />
        </el-form-item>
      </el-form>
...
<script>
import { listManage, getManage, delManage, addManage, updateManage } from "@/api/storage/manage";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getManage(storageId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除仓库信息编号为"' + storageIds + '"的数据项？').then(function() {
        return delManage(storageIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storage/manage/export', {
        ...this.queryParams
